...
<table class="form_table">
	<tr height="30">
		...
		<td><div id="ex_settlement_backup" class="explanation"><?php _e('Save the purchase information of the previous settlement. From the settlement log data, it is possible to create an order data.', 'usces'); ?></div></td>
	</tr>
</table>
-->
</div>
