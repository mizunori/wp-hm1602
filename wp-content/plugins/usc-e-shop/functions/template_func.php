...
//				<table id="retail_table_' . $umhs['ID'] . '" class="retail">';
	...
	//		$cartItemName = $this->getCartItemName($post_id, $sku);
			...
			$cart_item_name = '<a href="' . get_permalink($post_id) . '">' . esc_html($cartItemName) . '<br />' . $optstr . '</a>' . apply_filters('usces_filter_history_item_name', NULL, $umhs, $cart_row, $i);
